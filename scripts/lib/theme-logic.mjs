// The theme decision (REQ-007 as amended by A-03/A-04; plan D-09, D-13),
// shared by tests/theme.test.mjs and src/assets/js/theme.js: the inline head
// script must contain this function's exact source text (the test asserts
// it), so the tested logic and the shipped script cannot drift.
//
