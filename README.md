...
its path under `src/`. `pnpm build` also refuses a date in a file name,
because Eleventy would drop the date, and anything before it, from the URL;
...
`./_site/blog/ai-journey/index.html` `` followed by the two files.
